        ...
        <header>
            ...
            <section id="nav">
                <div>
                    <nav>
                        <ul>
                            <li style={{ 'background-color': '#0B4C50' }}>
                                <div class="menu">
                                    <a style={{ 'font-weight': 'bold', color: '#F7FE2E' }} href="">
                                        검색 사이트
                                    </a>
                                </div>
                                <ul>
                                    <li style={{ 'background-color': 'inherit'}}>
                                        ...
                                        <a style={{ 'font-weight': 'bold' }} href="https://www.naver.com" target='_blank'>
                                            네이버
                                        </a>
                                    </li>
                                    <li style={{ 'background-color': 'inherit' }}>

                                        <a style={{ 'font-weight': 'bold' }} href="https://www.google.com" target='_blank'>
                                            구글
                                        </a>
                                    </li>
                                </ul>
